...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?=ROOT?>/assets/css/style.css?92">
    ...
    <title><?=ucfirst($URL[0])?> - Melisma</title>
  </head>
  ...
  <body>
    ...
    <header class="dark-top">
      ...
      <div class="header-div">
        ...
        <?php if(!logged_in()):?>
          <div class="nav-item"><a href="<?=ROOT?>/register">Sign up</a></div>
        <?php endif; ?>

        <?php if(!logged_in()):?>
          <div class="nav-item"><a href="<?=ROOT?>/login">Log in</a></div>
        <?php endif; ?>
        <!-- hi user dropdown end -->
